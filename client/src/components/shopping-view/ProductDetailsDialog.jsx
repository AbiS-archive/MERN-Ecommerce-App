...
const ProductDetailsDialog = ({ open, setOpen, productDetails }) => {
  ...
  const { image, title, description, price, salePrice } = productDetails || {};
    ...
    if (getCartItems.length) {
      ...
      if (indexOfCurrentItem > -1) {
        ...
        if (getQuantity + 1 > getTotalStock) {
          toast({
            title: `Only ${getQuantity} amount can be added for this product`,
            variant: "destructive",
          });
      ...
      <DialogContent className="grid grid-cols-2 gap-8 sm:p-12 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[70vw]">
        ...
        <div className="">
          ...
          <div className="flex items-center justify-between">
            ...
            {salePrice > 0 ? (
              <p className="text-4xl font-bold text-primary">${salePrice}</p>
            ) : null}
          </div>
          <div className="flex items-center gap-2 mt-2">
            <div className="flex items-center gap-0.5">
              <RatingComponent rating={avgReview}/>
